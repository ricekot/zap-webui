      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            isActive &&
              "before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:h-6 before:w-0.5 before:bg-foreground before:rounded-r"
          )}
          aria-label={label}
        >
          {icon}
...
export function ActivityBar() {
  const { activeSidebarItem, activeBottomItem, setActiveSidebarItem, setActiveBottomItem } =
    useUIStore()
